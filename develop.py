...
def DoMainMenu():
    myscreen.erase()
    myscreen.addstr(1,1,  "========================================")
    myscreen.addstr(2,1,  "           Level's game Development")
    myscreen.addstr(3,1,  "========================================")
    myscreen.addstr(4,1,  "  1 - Show All Levels")
    myscreen.addstr(5,1,  "  2 - Search a level")
    myscreen.addstr(6,1,  "  3 - Show a level")
    myscreen.addstr(7,1,  "  4 - Delete a level")
    myscreen.addstr(8,1,  "  5 - Add a level")
    myscreen.addstr(9,1, "  0 - Exit")
    myscreen.addstr(10,1, "========================================")
    myscreen.addstr(11,1, "  Enter a selection: ")
    myscreen.refresh()
